...
_Last run: **2026-06-20 (Run #60)** — **⚡ HONEST DISPATCHER-FAULT CHIP — the `✕N` marker on the ⚡ DISPATCHABLE tab now tells a LIVE fault apart from a recovered/historical one, so a self-healed loop no longer glows a permanent red alarm.**
