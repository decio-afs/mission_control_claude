...
_Last run: **2026-06-20 (Run #58)** — **⚠ WEB-GAP WARNING ON THE ▲ PROMOTE PREVIEW — the todo→ready promote dry-run now flags which candidates would bounce on a web-gap BEFORE confirm.**
